...
// ignoreUndefinedProperties: o Firestore rejeita gravar campos `undefined`
// (ex.: caixinha sem prazo/cor => "Unsupported field value: undefined").
// Com isso, campos undefined são simplesmente omitidos na gravação, em todo o app.
